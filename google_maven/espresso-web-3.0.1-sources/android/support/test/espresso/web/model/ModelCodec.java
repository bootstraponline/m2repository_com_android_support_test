...
public final class ModelCodec {
  ...
  private static final CopyOnWriteArrayList<JSONAble.DeJSONFactory> DEJSONIZERS =
      new CopyOnWriteArrayList<JSONAble.DeJSONFactory>(Lists.newArrayList(
  ...
  public static Evaluation decodeEvaluation(String json) {
    ...
    if (obj instanceof Evaluation) {
      ...
      throw new IllegalArgumentException(
          String.format("Document: \"%s\" did not decode to an evaluation. Instead: \"%s\"",
            json, obj));
    }
  }
  ...
  private static JSONStringer encodeHelper(Object javaObject, JSONStringer stringer)
    ...
    if (null == javaObject) {
      ...
      checkState(converted, "%s: not encodable. Want one of: %s",
          javaObject.getClass(), VALUEABLE_CLASSES);
    }
    return stringer;
  }
}
