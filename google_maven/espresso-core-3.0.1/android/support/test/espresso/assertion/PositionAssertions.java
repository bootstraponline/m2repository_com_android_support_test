...
public final class PositionAssertions {
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is partially left of
   * the view matching the given matcher.
   *
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is partially right of
   * the view matching the given matcher.
   *
   * @throws junit.framework.AssertionFailedError if there is no horizontal overlap.
   * @throws AmbiguousViewMatcherException if more than one view matches the given matcher.
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is left aligned
   * with the view matching the given matcher.
   *
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is right aligned
   * with the view matching the given matcher.
   *
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is completely above
   * the view matching the given matcher.
   *
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is completely below
   * the view matching the given matcher.
   *
   * @throws junit.framework.AssertionFailedError if there is any vertical overlap.
   * @throws AmbiguousViewMatcherException if more than one view matches the given matcher.
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is partially above
   * the view matching the given matcher.
   *
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is partially below
   * the view matching the given matcher.
   *
   * @throws junit.framework.AssertionFailedError if there is no vertical overlap.
   * @throws AmbiguousViewMatcherException if more than one view matches the given matcher.
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is bottom aligned
   * with the view matching the given matcher.
   *
  ...
  /**
   * Returns a {@link ViewAssertion} that asserts that view displayed is top aligned
   * with the view matching the given matcher.
   *
