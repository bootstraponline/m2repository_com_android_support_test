...
public interface Tapper {
  ...
  /**
   * @deprecated
   * Use @{link #sendTap(UiController, float[], float[], int, int)} instead
   * This will call the @{link #sendTap(UiController, float[], float[], int, int)} with
   * {@link android.view.InputDevice#SOURCE_UNKNOWN},
   * {@link android.view.MotionEvent#BUTTON_PRIMARY} by default.
   */
  @Deprecated
  Status sendTap(
