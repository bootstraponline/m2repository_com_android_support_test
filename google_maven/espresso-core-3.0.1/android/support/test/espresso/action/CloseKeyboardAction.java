...
import android.support.test.espresso.base.IdlingUiController;
...
public final class CloseKeyboardAction implements ViewAction {
  ...
  private void tryToCloseKeyboard(View view, UiController uiController) throws TimeoutException {
    ...
    IdlingResourceRegistry resourceRegistry =
        ((IdlingUiController) uiController).getIdlingResourceRegistry();
    List<IdlingResource> idlingResourceList = Lists.newArrayList(idlingResult);
    resourceRegistry.registerResources(idlingResourceList);
    ...
    try {
      ...
      resourceRegistry.unregisterResources(idlingResourceList);
    }
  ...
  private static class CloseKeyboardIdlingResult extends ResultReceiver
    ...
    protected void onReceiveResult(int resultCode, Bundle resultData) {
      ...
      // The 300 millis number was chosen by running more then 100,000 tests and making sure there
      // were no flakiness.
      notifyEspresso(300);
    }
