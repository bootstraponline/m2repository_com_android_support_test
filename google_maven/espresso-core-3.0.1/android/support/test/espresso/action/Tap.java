...
public enum Tap implements Tapper {
  ...
  @Override
    public Tapper.Status sendTap(UiController uiController, float[] coordinates,
      ...
      Tapper.Status stat = sendSingleTap(uiController, coordinates, precision, inputDevice,
          buttonState);
  ...
  @Override
    public Tapper.Status sendTap(UiController uiController, float[] coordinates,
      ...
      MotionEvent downEvent = MotionEvents
          .sendDown(uiController, coordinates, precision, inputDevice, buttonState).down;
      try {
  ...
  @Override
    public Tapper.Status sendTap(UiController uiController, float[] coordinates,
      ...
      checkNotNull(coordinates);
      checkNotNull(precision);
      Tapper.Status stat = sendSingleTap(
      ...
      Tapper.Status secondStat = sendSingleTap(
          uiController, coordinates, precision, inputDevice, buttonState);
  ...
  private static Tapper.Status sendSingleTap(UiController uiController,
    ...
    checkNotNull(coordinates);
    checkNotNull(precision);
    DownResultHolder res = MotionEvents.sendDown(
        uiController, coordinates, precision, inputDevice, buttonState);
    try {
