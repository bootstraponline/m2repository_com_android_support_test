...
final class UiControllerImpl
  ...
  private IdleNotifier<IdleNotificationCallback> dynamicIdle;
  ...
  UiControllerImpl(
      ...
      IdleNotifier<IdleNotificationCallback> dynamicIdle,
      Looper mainLooper,
    ...
    this.dynamicIdle = checkNotNull(dynamicIdle);
  ...
  public void loopMainThreadUntilIdle() {
    ...
    do {
      ...
      if (!asyncIdle.isIdleNow()) {
        asyncIdle.registerNotificationCallback(new SignalingTask<Void>(NO_OP,
      ...
      if (!compatIdle.isIdleNow()) {
        compatIdle.registerNotificationCallback(new SignalingTask<Void>(NO_OP,
      ...
      if (!dynamicIdle.isIdleNow()) {
        ...
        dynamicIdle.registerNotificationCallback(new IdleNotificationCallback() {
          @Override
  ...
  private void loopUntil(EnumSet<IdleCondition> conditions) {
    ...
    try {
      ...
      interrogation = new MainThreadInterrogation(
          conditions,
          conditionSet,
          end);
      ...
      masterIdlePolicy.handleTimeout(idleConditions, String.format(
          "Looped for %s iterations over %s %s.", interrogation.execCount,
          masterIdlePolicy.getIdleTimeout(),
  ...
  private static final class MainThreadInterrogation
    ...
    @Override
    public void quitting() { /* can not happen  */ }
