...
/**
 * An internal interface UiControllerImpl uses to communicate with
 * sources of idleness.
 *
...
interface IdleNotifier<CB> {
  ...
  /**
   * Registers a callback to be invoked when the resources backed by the notifier
   * go idle.
   *
   * @param callback an object that the notifier will use to inform us about the
   *   idle state of the resources.
   */
