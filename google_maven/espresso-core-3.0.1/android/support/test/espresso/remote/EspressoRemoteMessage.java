 ...
 * TODO: Once this API is stable document on how and when these IFs need to be implemented
 */
public interface EspressoRemoteMessage {

  /** Transforms a class implementing this interface to a proto message.
   *
   * @param <M> This describes my type parameter M. M should either extend
   * {@link com.google.protobuf.MessageLite} or enum message
   */
  interface To<M> {
    M toProto();
  }
